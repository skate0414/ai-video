/**
 * Transcript sanitization utilities for style-safe reference text.
 * Masks topic-specific content (numbers, entities) to prevent content
 * contamination while preserving structural/stylistic patterns.
 *
 * Ported from ai-suite strategy for style fidelity improvement.
 */
