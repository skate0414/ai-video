/* ------------------------------------------------------------------ */
/*  StageRegistry – declarative stage definitions for the pipeline    */
/*  Each stage is a self-contained unit: given a RunContext,           */
/*  it knows how to execute itself and return a result.               */
/* ------------------------------------------------------------------ */
