#!/usr/bin/env bash
# Generate placeholder desktop app icons using ImageMagick.
...
ICONS_DIR="$SCRIPT_DIR/../browser-shell/icons"
...
if command -v convert &>/dev/null; then
  ...
  convert "$ICONS_DIR/icon.svg" -resize 256x256 "$ICONS_DIR/256x256.png"
  convert "$ICONS_DIR/icon.svg" -resize 512x512 "$ICONS_DIR/512x512.png"
  ...
  echo "   - 32x32.png, 128x128.png, 256x256.png, 512x512.png, icon.ico, icon.icns"
fi
